...
def args_menu():
    ...
    parser.add_argument('-c', '--command', type=str, help="Get Blob page by page, Blob Upload, Delete , Download for tenant, Get_vehicle_list, Get_Access_Token", required=True)
