        ...
        "domains": [
            {
                ...
                "config": [
                    {
                        "key": "image-opd-app-1",
                        "value": "https://api.devices.eu.bosch-mobility-cloud.com/v3/device/blobs/vehiclepkg_install_swc_app_opd_auto.tar?token=1b2217f3-03c4-4af4-99b0-e76ad7de08fd"
                    }
                ]
            }
        ],
